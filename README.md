...
Sirius is run as a standalone service, and does not have to be run on the same device that you are messaging from. Multiple Slack accounts are supported, even within the same running instance. A cloud version of sirius is coming soon.
